...
4. [Development Software & Tools](./4-development-software-and-tools.md)
    ...
    6. [AWS CLI](./4-development-software-and-tools.md#46-aws-cli)
    7. [Granted](./4-development-software-and-tools.md#47-granted)
    8. [Docker](./4-development-software-and-tools.md#48-docker)
    9. [kubectl](./4-development-software-and-tools.md#49-kubectl)
    10. [kubectx](./4-development-software-and-tools.md#410-kubectx)
    11. [K9s](./4-development-software-and-tools.md#411-k9s)
    12. [Java](./4-development-software-and-tools.md#12-java)
    13. [Apache Maven](./4-development-software-and-tools.md#413-apache-maven)
    14. [Apache Tomcat](./4-development-software-and-tools.md#414-apache-tomcat)
    15. [Quarkus CLI](./4-development-software-and-tools.md#415-quarkus-cli)
    16. [Node.js](./4-development-software-and-tools.md#416-nodejs)
    17. [Terraform](./4-development-software-and-tools.md#417-terraform)
    18. [IntelliJ IDEA](./4-development-software-and-tools.md#418-intellij-idea)
    19. [Visual Studio Code](./4-development-software-and-tools.md#419-visual-studio-code)
    20. Eclipse
    21. [DBeaver](./4-development-software-and-tools.md#421-dbeaver)
    22. [Postman](./4-development-software-and-tools.md#422-postman)
